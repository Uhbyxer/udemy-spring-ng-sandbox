...
@SpringBootTest(classes = RfblotaltyApp.class)
public class RfbLocationResourceIntTest {

    private static final String DEFAULT_LOCATION_NAME = "AAAAAAAAAA";
    private static final String UPDATED_LOCATION_NAME = "BBBBBBBBBB";

    private static final String DEFAULT_RUN_DAYS_OF_WEEK = "AAAAAAAAAA";
    private static final String UPDATED_RUN_DAYS_OF_WEEK = "BBBBBBBBBB";
    ...
    public static RfbLocation createEntity(EntityManager em) {
        RfbLocation rfbLocation = new RfbLocation()
            ...
            .runDaysOfWeek(DEFAULT_RUN_DAYS_OF_WEEK);
        return rfbLocation;
    }
    ...
    public void createRfbLocation() throws Exception {
        ...
        assertThat(testRfbLocation.getRunDaysOfWeek()).isEqualTo(DEFAULT_RUN_DAYS_OF_WEEK);
    }
    ...
    public void getAllRfbLocations() throws Exception {
        ...
        restRfbLocationMockMvc.perform(get("/api/rfb-locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].runDaysOfWeek").value(hasItem(DEFAULT_RUN_DAYS_OF_WEEK.toString())));
    }
    ...
    public void getRfbLocation() throws Exception {
        ...
        restRfbLocationMockMvc.perform(get("/api/rfb-locations/{id}", rfbLocation.getId()))
            ...
            .andExpect(jsonPath("$.runDaysOfWeek").value(DEFAULT_RUN_DAYS_OF_WEEK.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateRfbLocation() throws Exception {
        ...
        updatedRfbLocation
            ...
            .runDaysOfWeek(UPDATED_RUN_DAYS_OF_WEEK);
        ...
        assertThat(testRfbLocation.getRunDaysOfWeek()).isEqualTo(UPDATED_RUN_DAYS_OF_WEEK);
    }
