...
public class SessionResourceIntTest {
    ...
    private static final byte[] DEFAULT_DECRIPTION = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_DECRIPTION = TestUtil.createByteArray(2, "1");
    private static final String DEFAULT_DECRIPTION_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_DECRIPTION_CONTENT_TYPE = "image/png";
    ...
    public static Session createEntity(EntityManager em) {
        Session session = new Session()
            ...
            .decriptionContentType(DEFAULT_DECRIPTION_CONTENT_TYPE)
    ...
    public void createSession() throws Exception {
        ...
        assertThat(testSession.getDecription()).isEqualTo(DEFAULT_DECRIPTION);
        assertThat(testSession.getDecriptionContentType()).isEqualTo(DEFAULT_DECRIPTION_CONTENT_TYPE);
    ...
    public void getAllSessions() throws Exception {
        ...
        restSessionMockMvc.perform(get("/api/sessions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].decriptionContentType").value(hasItem(DEFAULT_DECRIPTION_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].decription").value(hasItem(Base64Utils.encodeToString(DEFAULT_DECRIPTION))))
    ...
    public void getSession() throws Exception {
        ...
        restSessionMockMvc.perform(get("/api/sessions/{id}", session.getId()))
            ...
            .andExpect(jsonPath("$.decriptionContentType").value(DEFAULT_DECRIPTION_CONTENT_TYPE))
            .andExpect(jsonPath("$.decription").value(Base64Utils.encodeToString(DEFAULT_DECRIPTION)))
    ...
    public void updateSession() throws Exception {
        ...
        updatedSession
            ...
            .decriptionContentType(UPDATED_DECRIPTION_CONTENT_TYPE)
        ...
        assertThat(testSession.getDecription()).isEqualTo(UPDATED_DECRIPTION);
        assertThat(testSession.getDecriptionContentType()).isEqualTo(UPDATED_DECRIPTION_CONTENT_TYPE);
